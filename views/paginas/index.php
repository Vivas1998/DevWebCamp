    ...
    <div class="speakers__grid">
        <?php foreach($ponentes as $ponente) { ?>
            <div <?php aos_animacion(); ?> class="speaker">
                <picture>
                    <source srcset="<?php echo $_ENV['HOST'] . '/build/img/speakers/' . $ponente->imagen; ?>.png" type="img/png">
                    <source srcset="<?php echo $_ENV['HOST'] . '/build/img/speakers/' . $ponente->imagen; ?>.webp" type="img/webp">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/build/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen ponente">
                </picture>
