...
class RegistroController {
    ...
    public static function conferencias(Router $router) {
        ...
        // Redireccionar al boleto virtual en caso de ya estar registrado
        if(isset($registro->regalo_id) && $registro->paquete_id === "1") header('Location: /boleto?id=' . urlencode($registro->token));
